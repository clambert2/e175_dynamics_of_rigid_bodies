...
IAxx                            =  50;                     % g*cm^2              Constant
IBxx                            =  2500;                   % g*cm^2              Constant
IByy                            =  500;                    % g*cm^2              Constant
IBzz                            =  2000;                   % g*cm^2              Constant
LA                              =  7.5;                    % cm                  Constant
LB                              =  20;                     % cm                  Constant
mA                              =  0.01;                   % kg                  Constant
mB                              =  0.1;                    % kg                  Constant

qA                              =  90;                     % degrees             Initial Value
qB                              =  1;                      % degrees             Initial Value
qADt                            =  0;                      % UNITS               Initial Value
qBDt                            =  0;                      % UNITS               Initial Value

tInitial                        =  0.0;                    % second              Initial Time
tFinal                          =  20;                     % second              Final Time
...
DEGtoRAD = pi / 180.0;
RADtoDEG = 180.0 / pi;
IAxx = IAxx * 1.0E-07;                                     %  Converted from g*cm^2 
...
qA = qA * DEGtoRAD;                                        %  Converted from degrees 
qB = qB * DEGtoRAD;                                        %  Converted from degrees 
...
if( isempty(Output) ),
   if( ~isempty(FileIdentifier) ),
      ...
      fprintf( 1, '\n Output is in the files baby_boot.i  (i=1,2)\n\n' );
   end
